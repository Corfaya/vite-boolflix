...
export default {
    ...
    computed: {
        ...
        threePerSlide() {
            ...
            for (let i = 0; i < this.topMovies.length; i += 4) {
                arrayImgSlide.push(this.topMovies.slice(i, i + 4));
            }
...
<template>
    ...
    <div id="carousel-move" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            <button v-for="film, i in slidesTotal" :key="i" type="button" data-bs-target="#carousel-move"
